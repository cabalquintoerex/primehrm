...
const steps = [
  {
    number: 1,
    title: 'Define Positions in the Catalog',
    actor: 'LGU HR Admin',
    module: 'Positions',
    path: '/rsp/positions',
    icon: Briefcase,
    items: [
      ...
      'Fills in: Position Title, Plantilla Item No., Salary Grade (auto-fills monthly salary), Place of Assignment, Office/Department',
      ...
      'The position is saved to the master catalog \u2014 a reusable definition with no status or vacancy count of its own',
    ],
    note: 'Catalog positions are reusable: the same definition can be added to many publications over time.',
  },
  {
    number: 2,
    ...
    actor: 'LGU HR Admin',
    module: 'Publications',
    path: '/rsp/publications',
    icon: FileStack,
    items: [
      'HR Admin clicks "New Publication"',
      'Fills in: Publication Number (unique per LGU), Posting Date, Closing Date (auto-calculated: Posting Date + 15 calendar days), Description (optional)',
      'System creates the publication with status Unpublished',
      'HR Admin can edit or delete the publication while it is unpublished',
    ],
  },
  {
    number: 3,
    title: 'Add Positions and Publish',
    actor: 'LGU HR Admin',
    module: 'Publication Detail Page',
    path: '/rsp/publications/:id',
    icon: Globe,
    items: [
      'On the publication detail page, HR Admin clicks "Add Positions" and selects catalog positions, setting the number of vacancies for each',
...
const statusFlows = [
  {
    ...
    descriptions: [
      ...
      { status: 'OPEN', desc: 'Published within its publication, visible on careers page, accepting applications' },
...
const rolePermissions = [
  ...
  { action: 'Manage Publications', super: 'View Only', hr: true, office: false, applicant: false },
  { action: 'Create/Edit Positions', super: 'View Only', hr: true, office: false, applicant: false },
  { action: 'Publish/Unpublish Publication', super: 'View Only', hr: true, office: false, applicant: false },
